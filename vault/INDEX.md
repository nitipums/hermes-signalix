...
> **Last reconciled:** 2026-09-03 18:30 ICT · W3 gate + additive Daily structure + main-list phase grouping served; W2 candidate-lane experiment remains deferred; evaluator auto-caller separate.
...
| `Research-Index.md` | Index/router for isolated Wave playbooks, replay, AutoResearch, and portfolio research | ✅ current research index | Research-only; formula authority: `Research-Playbook-Bible.md`; project map: `../docs/current/2026-09-05-wave-playbooks-research-project.md` |
| `Research-Playbook-Bible.md` | Current deterministic playbook formulas, evidence status, SHADOW_READY gate, and next research sequence | ✅ current research authority | Research-only; does not change product/API/production authority |
...
| `../docs/current/2026-09-03-signalix-skill-document-boundary.md` | Boundary between canonical Signalix documents and Lite procedural skills | ✅ current | cleanup control record; not product authority |
| `../docs/current/2026-09-10-1332-ohlcv-window-summary-handoff.md` | Current deterministic OHLCV window summary, API/runtime/browser evidence, and resume boundary | ✅ current handoff | Contract authority remains the focused Elliott/Trend/Trade-Setup spec; implementation is production-served |
| `../docs/superpowers/specs/2026-09-11-private-actionable-signal-design.md` | Private deterministic market-buy shadow policy | ✅ current focused authority | Phase 1 is a portfolio-independent 7-day UI; position-aware sells, alerts, and broker execution remain later work |
| `../docs/current/2026-09-03-daily-structure-evidence-integration-spec.md` | Additive Daily Wave 1/2/4/5 structural evidence contract | ✅ current design | implemented/served in 9ec9e20; main phase grouping served in 9669e2e; W2 lane experiment deferred |
| `2026-09-03-1830-main-mvp-daily-phase-grouping-handoff.md` | Main `/mvp` Daily structural phase grouping/filter journey | ✅ current milestone | presentation-only; primary/lane/W3 gate unchanged |
